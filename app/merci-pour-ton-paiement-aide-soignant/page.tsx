...
export default function ThankYouAideSoignantPage() {
      ...
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Félicitations ! Ton inscription à la formation VAE Aide-Soignant (DEAS)
            est confirmée. Tu vas bientôt transformer ton expérience en diplôme !
          </p>
        </div>
            ...
            <CardContent className="p-6">
              ...
              <dl className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <dd className="font-medium">VAE Aide-Soignant (DEAS)</dd>
                </div>
                <div className="flex justify-between">
