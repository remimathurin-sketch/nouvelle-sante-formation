...
export const metadata: Metadata = {
  title: 'Paiement VAE Auxiliaire de Vie (DEAES) - Nouvelle Santé Formation',
  description:
    "Finalisez votre inscription à la formation VAE Auxiliaire de Vie. Paiement sécurisé par Stripe.",
}
...
export default function PaymentAuxiliaireDeViePage() {
  return (
          ...
          <div>
            <div className="mb-8">
              ...
              <p className="mt-2 text-muted-foreground">
                VAE Auxiliaire de Vie (DEAES) - Formation complète
              </p>
            </div>

            <CheckoutForm formation="auxiliaire-de-vie" />
          </div>
